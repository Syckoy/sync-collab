...
## Quoi mettre sur GitHub

**Seulement les scripts** (quelques Ko). Jamais le serveur, jamais `tools\`, jamais `st-home\`.
...
Raccourci : double-clic sur `preparer-github.bat` → ca cree `Desktop\sync-collab-GITHUB` tout leger, pret a glisser sur GitHub.
